        ...
        <div class="card-body">
          ...
          <form :schema="schema" :state="state" @submit.prevent="onSubmit">
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" v-model="state.contact_no" id="contact_no" placeholder="+65 9123 4567" required />
            </div>
            <div class="mb-3">
          ...
          <div class="text-center mt-3">
            <NuxtLink to="/register" class="link-secondary">Back to account type selection</NuxtLink>
          </div>
        </div>
      </div>
    </div>
